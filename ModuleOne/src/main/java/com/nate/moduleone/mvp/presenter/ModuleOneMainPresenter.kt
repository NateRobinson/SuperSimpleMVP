...
@ActivityScope
class ModuleOneMainPresenter
@Inject constructor(model: ModuleOneMainContract.Model, rootView: ModuleOneMainContract.View) :
  SSBasePresenter<ModuleOneMainContract.Model, ModuleOneMainContract.View>(model, rootView) {
